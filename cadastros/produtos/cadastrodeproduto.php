   ...
   <header>
    ...
    <form id="cadastroForm">
        <div class="inputBox">
            ...
            <input placeholder="PRODUTO" type="text" id="produto" name="produto" required>
        </div>

        <div class="inputBox">
            <label for="valor">VALOR</label>
            <input placeholder="VALOR" type="text" id="valor"  onkeypress="$(this).mask('R$ ###.###.##',{ reverse: true }) " name="valor" required>
